...
def render_packet(packet) -> str:
    return "\n".join(
        [
            ...
            f"Est Accel (G):      x={packet.est_acceleration_x_gs: >8.4f}, y={packet.est_acceleration_y_gs: >8.4f}, z={packet.est_acceleration_z_gs: >8.4f}",
            f"Est Rate (rad/s):   x={packet.est_angular_rate_x_rad_per_s: >8.4f}, y={packet.est_angular_rate_y_rad_per_s: >8.4f}, z={packet.est_angular_rate_z_rad_per_s: >8.4f}",
